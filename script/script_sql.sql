...
drop index AUTHERIZATION_ROL_FK;

drop index TREE_USERS_FK;

drop index APP_USER_PK;

drop table APP_USER;

drop index AUTHORIZATION_PERMISSION_FK;

drop index AUTHORIZATION_PERMISSION2_FK;

drop index AUTHORIZATION_PERMISSION_PK;

drop table AUTHORIZATION_PERMISSION;

drop index PERMISSION_PK;
...
drop index USER_RESPONSABILITIES_FK;

drop index TEAM_RESPONSABILTIES_FK;

drop index STATE_BY_TASK_FK;

drop index TASK_PK;

drop table TASK;

drop index TASK_STATE_PK;
